...
{
  var text_pmw = many_words(document.getElementById('content').value);
  ...
  document.getElementById('content').value = ans;
  ...
  //document.getElementsByName('html_text')[0].value = html_txt;
}
